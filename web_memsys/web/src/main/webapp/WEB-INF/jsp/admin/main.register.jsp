...
<div id="register" class="body-item register object-item window">
    ...
    <div class="register-item content">
        <form class="content-item form">
            <div class="form-item input-container">
                <input type="email" name="email" id="inputRegisterEmail" placeholder="이메일" maxlength="100">
            </div>
            <div class="form-item input-container">
                <input type="password" name="password" id="inputRegisterPassword" placeholder="비밀번호" maxlength="50">
            </div>
            <div class="form-item input-container">
                <input type="password" name="checkPassword" id="inputRegisterCheckPassword" placeholder="비밀번호 확인" maxlength="50">
            </div>
            <div class="form-item input-container">
    ...
    <div class="register-item buttons">
